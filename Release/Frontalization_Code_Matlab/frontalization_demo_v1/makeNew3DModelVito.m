...
%   ver 1.2, 18-May-2015
%
load model3DSDM Model3D
imref = imread('reference_320_320.png');
imshow(imref)
addpath /dlib/dlib/matlab/
model = generateCMR_model1('Vito/model');

bbox= dlibFaceDetect(rgb2gray(imref),[]);
bbox=bbox(1,:);
landmarks = CMRfind_facial_landmarks(imref,bbox,model.Ldetector,1);
