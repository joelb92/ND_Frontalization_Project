...
% 
function amodel = generateCMR_model1(mpath)
...
pfaceDetector = vision.CascadeObjectDetector('ProfileFace');
...
pfaceDetector.MinSize = [20 20];
pfaceDetector.ScaleFactor = 1.1;
VJdetector.fdetector = faceDetector;
VJdetector.pdetector = pfaceDetector;
