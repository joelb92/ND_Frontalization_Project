function [trans,uv,xy,uv_dev,xy_dev] = mycp2tform(varargin)
...
%   $Revision: 1.10.4.14 $  $Date: 2009/09/28 20:24:23 $
...
[dum index] = min(vcos); % dum never used
...
narginchk(2,4)%iptchecknargin(2,4,nargin,mfilename);
...
if isa(varargin{1},'struct')
    ...
    narginchk(3,4)%iptchecknargin(3,4,nargin,mfilename);
