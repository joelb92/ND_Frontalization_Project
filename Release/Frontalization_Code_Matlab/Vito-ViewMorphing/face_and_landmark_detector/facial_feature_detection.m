...
%   ver 1.2, 18-May-2015
%
function [Model3D,fidu_XY,bbox] = facial_feature_detection(detector,I_Q,filename,landmarks,Model3D,dlibdetector,dlibpredictor,dlibmodule,dmod)
fidu_XY = [];
mod = dlibmodule;
bbox = [];
switch detector
